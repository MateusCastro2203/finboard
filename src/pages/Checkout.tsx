        ...
        >
          ...
          >
            ...
            <div className="flex flex-col items-end gap-0.5">
              <span className="font-mono-data text-xs" style={{ textDecoration: "line-through", color: "var(--text-3)" }}>
                R$ 197,00
              </span>
              <span className="font-mono-data" style={{ fontSize: "1.5rem", fontWeight: 400, color: "var(--gold)" }}>
                R$ 98,60
              </span>
            </div>
          </div>
          ...
          >
            ...
            PIX · Cartão · Boleto · Saldo MP · 7 dias de garantia
          </p>
        </div>
      </div>
    </div>
